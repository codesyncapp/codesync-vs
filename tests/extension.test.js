...
describe("Extension: activate",() => {
    ...
    test("With deactivated user, repo is connected", async () => {
        ...
        addUser(baseRepoPath);
        await activate(vscode.ExtensionContext);
        console.log(vscode.commands.executeCommand.mock.calls);
        expect(vscode.commands.executeCommand).toHaveBeenCalledTimes(9);
        // showLogin should be true
        expect(vscode.commands.executeCommand.mock.calls[0][0]).toStrictEqual(contextVariables.setContext);
        expect(vscode.commands.executeCommand.mock.calls[0][1]).toStrictEqual(contextVariables.showLogIn);
        expect(vscode.commands.executeCommand.mock.calls[0][2]).toStrictEqual(false);
        ...
        expect(vscode.commands.executeCommand.mock.calls[6][1]).toStrictEqual(contextVariables.showLogIn);
        ...
        expect(vscode.commands.executeCommand.mock.calls[7][1]).toStrictEqual(contextVariables.showReactivateAccount);
        ...
        expect(vscode.commands.executeCommand.mock.calls[8][1]).toStrictEqual(contextVariables.showConnectRepoView);
