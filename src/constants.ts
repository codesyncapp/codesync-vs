...
export const NOTIFICATION = {
	...
	UPDATE_SYNCIGNORE: ".syncignore has the same format as .gitignore. You can add all the files you don't want to sync to your .syncignore and save the file",
	SYNC_IGNORE_CREATED: "I've created a file called .syncignore (similar to .gitignore). You can add all the files you don't want to sync to your .syncignore and save the file",
