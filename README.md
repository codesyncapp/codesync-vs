...
- **Seamless IDE Integration:** Automatically generate summaries based on actual progress made in your IDE, so you never miss key changes or updates in your codebase. No git commits required!
...
We support both cloud and self-hosting via AWS and GCP (on-prem). If you’d like your data and infrastructure to be within your own AWS account, [contact us](mailto:support@codesync.com) us for a free trial of the on-prem option. 
